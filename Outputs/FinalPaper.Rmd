...
```{r figeight, out.width="90%", echo=FALSE, fig.cap = "Probability of seeking Professional Mental Health Care in Each Country"}
...
df %>%
  knitr::kable(caption = "Accuracy of Predictions") %>% 
  kable_styling(latex_options = "HOLD_position")
```
...
Older versions years of the dataset, i.e datasets for previous years are being hosted on their own web pages. 
